...
const personalNewsDB = {
    ...
    writeYourGenres:function() {
        // for(let i = 1; i < 2; i++) {
        //     let genre = prompt(`Sizning sevimli jamringiz nomer ${i}`);
        //     if(genre === "" || genre === null) {
        //         console.log("Siz notog'ri molumat kiritingiz");
        //         i--
        //     } else {
        ...
        for(let i = 1; i < 2 i++) {
            let genre = prompt(`Sizning sevimli jamringiz nomer, vergul yordamida yozing`).toLocaleLowerCase();
            if(gaenre === "" || gaenre === null ) {
                console.log("Siz notog'ri molumat kiritingiz");
            } else{
        ...
        personalNewsDB.genres.forEach((item, i) => {
            console.log(`Sizning sevimli jamringiz: nomer ${i} bu ${item}`);
        })
    },
}
